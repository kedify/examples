...
| ------------------------------------------ | ------------------------------------ | ----------------------------------- |
| [agent-without-http-add-on](./agent-without-http-add-on) | This example demonstrates the Kedify Agent running without the HTTP Add-on and starting its HTTP Scaler controllers automatically once the HTTPScaledObject CRD appears | Kedify HTTP |
