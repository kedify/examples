...
Before the benchmark, we will make the KEDA behaviour more rapid, both scaling up and scaling down. This is unlikely something you'd want in a production environment, but it is helpful in demos and when testing KEDA behaiour.
```
